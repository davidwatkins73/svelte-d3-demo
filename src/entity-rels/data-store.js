...
const tags = {
    ...
    bcbs: {name: "BCBS"},
    ft: { name: "FT"},
    records: { name: "Records Management" },
...
const relationships = [
    ...
    { source: entities.surveyTemplate, target: entities.surveyInstance, type: relTypes.has, cardinality: "1n", tags: [tags.surveys]},
    { source: entities.surveyInstance, target: entities.surveyQuestionResponse, type: relTypes.has, cardinality: "1n", tags: [tags.surveys]},
    { source: entities.application, target: entities.surveyInstance, type: relTypes.has, cardinality: "1n", tags: [tags.records, tags.surveys]},
    { source: entities.changeInitiative, target: entities.surveyInstance, type: relTypes.has, cardinality: "1n", tags: [tags.surveys]},
    ...
    { source: entities.assessmentDefinition, target: entities.assessment, type: relTypes.has, cardinality: "1n", tags: [tags.records]},
    { source: entities.assessmentDefinition, target: entities.ratingScheme, type: relTypes.has, cardinality: "1n", tags: [tags.records]},
    { source: entities.assessment, target: entities.ratingSchemeItem, type: relTypes.has, cardinality: "1n", tags: [tags.records]},
